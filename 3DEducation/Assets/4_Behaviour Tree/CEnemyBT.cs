...
public class CEnemyBT : MonoBehaviour
{
    ...
    [SerializeField] bool mIsGrenade = false;    //수류탄 소지 여부

    [SerializeField] Vector3 mSpawnAnyPosition = Vector3.zero; //원래 지점

    [SerializeField] float mDetectedRadius = 0f; //탐지 반경
